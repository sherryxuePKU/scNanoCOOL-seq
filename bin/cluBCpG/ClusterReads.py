...
class ClusterReads:
    ...
    def __init__(self, bam_a: str, fa: str, bam_b=None, bin_size=100, bins_file=None, output_directory=None, num_processors=1,
    ...
    def process_bins(self, bin):
        ...
        bam_parser_A = BamFileReadParser(self.bam_a, self.fa, 20, read1_5=self.mbias_read1_5, read1_3=self.mbias_read1_3,
        ...
        if not self.single_file_mode:
            bam_parser_B = BamFileReadParser(self.bam_b, self.fa, 20, read1_5=self.mbias_read1_5, read1_3=self.mbias_read1_3,
                                            read2_5=self.mbias_read2_5, read2_3=self.mbias_read2_3, no_overlap=self.no_overlap)
